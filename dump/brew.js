...
// Parameters
const recipeName = 'multiple-operations-recipe-test-postman-input3'; //
const projectName = 'multiple-operations-project-test-postman-input3'; //
const datasetParams = {
   datasetName : 'multiple-operations-resolution-dataset-postman-input3', //
   datasetFormat : 'CSV', //
   datasetDelimiter : ',', //
...
const jobParams = {
   jobName : 'multiple-columns-job-postman-input3', //
